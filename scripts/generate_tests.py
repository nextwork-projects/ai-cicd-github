...
6. Do not use Markdown formatting in the test code. Do not wrap code in markdown code blocks
7. Output must be a valid Python file.
...
def main():
    ...
    for file_path in changed_files:
        ...
        if not file_path.endswith('.py'):
            continue
        # Skip test fileshow do you check if it starts with tests/?:
